...
public class GJDepthFirst2<R,A> implements GJVisitor<R,A> {
   ...
   public static HashMap copy(HashMap<String, HashMap> original)
		{
		    HashMap<String, HashMap<String, String>> copy = new HashMap<String, HashMap<String, String>>();
		    for (Map.Entry<String, HashMap> entry : original.entrySet())
		    {
		        copy.put(entry.getKey(), (HashMap)original.get(entry.getKey()).clone());
		    }
		    return copy;
		}
   ...
   public R visit(PrintStatement n, A argu) {
      R _ret=null;
      if((Integer)argu==0){
        snap_map.put(n, copy(sc_map));   //take snap before sopln, no need to call n.f0
      }
      else if((Integer)argu==1){
